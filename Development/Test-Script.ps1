...
$ProviderMachineName = "srvSCCMTP1.ademo.at" # SMS Provider machine name
$initParams = @{}
...
[String[]]$ApplicationName = "KeePass 2.48.1 2.48.1 RZ21130728"
...
$Application = $ApplicationName[0]
    ...
    If (!($Null -eq $TotalDeploymentTypes) -or (!($TotalDeploymentTypes -eq 0))) {
        ...
        $Object.Installer.CustomData.DetectionScript | Select-Object -Property *
        $Object.Installer.CustomData.DetectionScript | Select-Object -Property *
